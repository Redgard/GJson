...
namespace GJson
{
	...
	public class Buffer
	{
		...
		public Buffer(string s)//, bool isUserStream)
		{
			...
			buf = s;// new byte[(bufLen > 0) ? bufLen : MIN_BUFFER_LENGTH];
			fileLen = bufLen = s.Length;
	...
	public class Scanner
	{
		...
		public Scanner(string inputString)
		{
			...
			buffer = new Buffer(inputString);//, false);
			Init();
		}
